              ...
              <div class="col-lg-3 d-flex-column">
                    <div class="group_menu">
                      <p class="title_footer">Menu</p>
                        ...
                        <a href="{{route('sitio.index')}}#contacto">Contactanos</a>
                        <a href="{{route('sitio.terminos')}}">Política de privacidad</a>
                        <a href="{{route('sitio.condiciones')}}">Condiciones de uso</a>
                    </div>
              </div>
